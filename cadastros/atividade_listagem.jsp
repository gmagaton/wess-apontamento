...
<div id="wrap">
	...
	<div id="content2">
		...
		<p class="add"> <s:a href="Atividade.action"><img src="imagens/new.jpg" border="0" />Adicionar Atividade</s:a></p>
	...
	<display:table 
		id="atividadeDTO"
		name="LISTOBJECTS"
		requestURI="Atividade!listObjects.action"
		export="true"
		pagesize="30">	
		<display:caption media="pdf">Atividades dos Projetos</display:caption>
		<display:column property="atividadeId" title="C�digo" sortable="true"/>
		<display:column property="descricao" title="Descri��o" sortable="true"/>	
		<display:column media="html" style="text-align:center;">	
			<s:url id="editar_url" action="Atividade"  method="retrieveById">
	            <s:param name="atividade.atividadeId" value="#attr.atividadeDTO.atividadeId" />
	        </s:url>        
			<s:a href="%{editar_url}">
		...
		<display:column media="html" style="text-align:center;">	
			<s:url id="remover_url" action="Atividade"  method="remove">
	            <s:param name="atividade.atividadeId" value="#attr.atividadeDTO.atividadeId" />
	        </s:url>        
