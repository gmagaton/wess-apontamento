...
<div id="wrap">
	...
	<div id="content2">
		...
		<h3>Lista de Tipos de Horas</h3>
		<p class="add"> <s:a href="TipoHora.action"><img src="imagens/new.jpg" border="0" />Adicionar Tipo de Hora</s:a></p>
...
<display:table 
	id="tipoHoraDTO"
	name="LISTOBJECTS"
	requestURI="TipoHora!listObjects.action"
	export="true"
	pagesize="30">	
	<display:caption media="pdf">Tipos de Horas</display:caption>
	<display:column property="tipoHoraId" title="C�digo" sortable="true"/>
	<display:column property="descricao" title="Descri��o" sortable="true"/>
	<display:column property="percentualAcrescimo" title="Acr�scimo (%)" format="{0,number, 0.00}" sortable="true" />
	<display:column property="percentualDesconto" title="Desconto (%)" format="{0,number,0.00}" sortable="true" />
	
	<display:column media="html" style="text-align:center;">	
		<s:url id="editar_url" action="TipoHora"  method="retrieveById">
            <s:param name="tipoHora.tipoHoraId" value="#attr.tipoHoraDTO.tipoHoraId"/>
        </s:url>        
		<s:a href="%{editar_url}">
	...
	<display:column media="html" style="text-align:center;">	
		<s:url id="remover_url" action="TipoHora"  method="remove">
            <s:param name="tipoHora.tipoHoraId" value="#attr.tipoHoraDTO.tipoHoraId"/>
        </s:url>        
